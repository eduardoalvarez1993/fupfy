...
// Function to update pricing based on toggle
function updatePricing() {
    const isAnnual = billingSwitch.checked;

    pricingCards.forEach(card => {
        const monthlyPriceElements = card.querySelectorAll(".monthly-price");
        const annualPriceElements = card.querySelectorAll(".annual-price");
        const originalMonthlyPriceElement = card.querySelector(".original-monthly-price");

        if (isAnnual) {
            // Show annual price, hide monthly price, show original monthly price with strikethrough
            monthlyPriceElements.forEach(el => el.style.display = "none");
            annualPriceElements.forEach(el => el.style.display = "inline");
            if (originalMonthlyPriceElement) {
                originalMonthlyPriceElement.style.display = "inline";
            }
        } else {
            // Show monthly price, hide annual price, hide original monthly price
            monthlyPriceElements.forEach(el => el.style.display = "inline");
            annualPriceElements.forEach(el => el.style.display = "none");
            if (originalMonthlyPriceElement) {
                originalMonthlyPriceElement.style.display = "none";
            }
        }
    });
}
...
// Initial pricing update on page load
updatePricing();
